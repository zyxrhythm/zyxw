...
<body>
<p style='color: red; text-decoration: none; '><small><<</small><input type='button' style='background:none; border:none; font-size:105%' value='back | track' onClick='history.go(-1);'></p>
<hr>
<br><br><br><br><br><br>
<!--tagaddperiod0-->
<div id="addperiod">

...
> Do a 'dig' of D.N.S. records (A,MX,SOA,NS,TXT,SPF,CAA,AAA) of domain names, sub domains and hostnames directly from one of Google's name server (8.8.8.8), or from a particular name server specified by the user. 

...
3. Configure the host and make the /cgi-bin folder able to execute bash scripts and make sure the necessary programs are installed on te host (the list of the necessary tools are above, on #3 ). 

---------------------

Customizations and Preferences:

- Edit the /zyx/lib/vars/site.vars to change 'browser tab titles', 'messages' and other 'texts' on the website pages.

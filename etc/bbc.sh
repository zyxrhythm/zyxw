...
<label><div class="tooltip">[ Big Nick Digger ]<span class="tooltiptext" style="font-size: 70%; font-family: calibri; font: green; ">To reverse an IP address select PTR from the dropdown. <br>Big Nick Digger will dig from Google's DNS sever (8.8.8.8) by default. </span></div></label>
<br> 

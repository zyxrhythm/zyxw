...
<div class="tooltip">
<a id="tools-link" href='/cgi-bin/bbcx.sh?domain=' target='_blank' ><label> &#127797; BBC Special </label></a>
...
<label>
<div class="tooltip">
<a id="tools-link" href='/cgi-bin/bbcws.sh?domain=' target='_blank' ><label> &#8284; Who You </label></a>
...
<label>
<div class="tooltip">
<a id="tools-link" href='/cgi-bin/bbcd.sh?domain=&record=ANY&nameserver=' target='_blank' ><label> &#9935; Big Nick Digger </label></a>

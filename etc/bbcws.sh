...
<div id="Registry" class="tabcontent" style=display:block >
	<table> <tbody> <td style="font-size: 87%; color: #9DC209;"><strong>Whois server:</strong> ${rws0#*server}</td> </tbody> </table><br>
...
<div id="Registrar" class="tabcontent" >
	<table> <tbody> <td style="font-size: 87%; color: #9DC209;"><strong>Whois server:</strong> $rws</td> </tbody> </table><br>

...
then 
rws="Not Found!"; 
zyxregistrar="Unable to fetch the whois infomartion from the Registrar!<br><br><br>Possible causes: <br>-Input is not a valid/registered domain name. <br>-The whois server of the Registrar does not respond to whois queries via port 43 (a web interface might be available).<br>-There is no such server from the Registrar."

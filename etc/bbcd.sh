...
tablefunc () {
echo -e "<tr><td style='text-align: center;'><strong>Type\t</strong></td><td style='text-align: center;'><strong>TTL\t</strong></td><td style='text-align: center;'><strong>Record\t</strong></td></tr>"
while IFS= read -r line
do

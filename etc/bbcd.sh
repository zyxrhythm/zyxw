...
<button onclick="copyClipboard()" >Copy Results</button><div class="tooltip"> <label>&#128072;</label> &nbsp; &nbsp;<span class='tooltiptext' > <br>Click the Copy button to copy the results, <br>then simply do a "paste" on your text editor <br>or note taking app.<br><br></span></div>
&nbsp;
...
then echo -e "<tr><td>$rtype</td><td>$ttl</td><td style='word-break:break-all; ' >$record</td></tr>" ; 
else echo -e "<tr><td>$rtype</td><td>$ttl</td><td>$record</td></tr>"; 
fi;
done < <(printf '%s\n' "$1");
echo "<table>"
}
